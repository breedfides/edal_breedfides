...
/**
 * The <code>SubjectviewDialog</code> can be used to view <code>Subjects</code>,
...
public class SubjectsViewDialog extends MetadataViewDialog {
	...
	/**
	 * Constructs a <code>SubjectviewDialog</code> that is initialized with
	 * <code>subjects</code>.
	 * 
	 * @param subjects
	 *            <code>UntypedData</code> Set
	 * @param title
	 *            the title for the dialog
	 */
	public SubjectsViewDialog(Set<UntypedData> subjects, String title) {
		super();
	...
	private void initUi() {
		...
		dm = buildtable(subjects, columnNames);
		table = new JTable(dm);
	...
	private EdalTableModel buildtable(Set<UntypedData> strs, Object[] columnNames) {
