 ...
 * @author arendd
 */
public class IndexWriterThread2 extends EdalThread {
	...
	protected IndexWriterThread2(final SessionFactory sessionFactory, final Path indexDirectory,
...
//			session.getTransaction().commit();
			...
			try {
				Thread.sleep(Math.min(
						Math.max(indexingTime * IndexWriterThread2.SLEEP_RUNTIME_FACTOR,
								IndexWriterThread2.MIN_THREAD_SLEEP_MILLISECONDS),
						IndexWriterThread2.MAX_THREAD_SLEEP_MILLISECONDS));
